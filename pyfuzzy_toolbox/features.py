...
def max_rule_score_for_unigrams_and_bigrams(bow_sentences, unigram=ADJS, bigram_word_1=ADVS, bigram_word_2=ADJS):
    ...
    unigram_sign_and_value = max_rule_score_for_unigrams(bow_sentences, unigram=unigram)
    bigram_sign_and_value = max_rule_score_for_bigrams(bow_sentences, bigram_word_1=bigram_word_1, bigram_word_2=bigram_word_2)
